...
The command pin_in returns an array of size two, containing the values of the switches.  By using two nested if statements, each of the elements returned by pin_in to decide what action to take.
